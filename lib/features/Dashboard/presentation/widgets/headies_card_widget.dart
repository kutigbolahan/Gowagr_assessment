    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          Row(
            children: [
              CircleAvatar(backgroundImage: AssetImage(headies), radius: 25),
              const SizedBox(width: 10),
              Expanded(
                child: GowagrTextWidget(
                  text: 'Who Wins Headies Next Rated \nAward 2024?',
      ...
      children: [
        ...
        Expanded(
          child: Container(
            ...
            decoration: BoxDecoration(
              border: Border.all(
                color: appColors.blue0166F4.withValues(alpha: 0.5),
              ),
        ...
        Expanded(
          child: Container(
            ...
            decoration: BoxDecoration(
              border: Border.all(
                color: appColors.redFF4E4E.withValues(alpha: 0.5),
              ),
              borderRadius: BorderRadius.circular(6),
