...
class DateTimeUtils {
  ...
  static String formatDateToDateTime(DateFormat dateFormat, String time) {
    try {
      // Parse the time string into DateTime.
      // This assumes `time` is in the format '12:43 PM'
...
final dateTimeMonthFormat = DateFormat('hh:mm a, dd MMM');
...
final fullMonthOfYearFormat1 = DateFormat('EEE, d MMMM y');
